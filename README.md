# ActiveDirectory_Lab
This lab will simulate a real world enterprise environment using Active Directory domain services within a virtualised environment.
...
The hypervisor used will be virtual box on a Windows 11 system.
